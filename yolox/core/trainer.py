...
from yolox.utils.metric import MeterBuffer
...
class Trainer:
    ...
    def resume_train(self, model):
        if self.args.resume:
            ...
            ckpt = paddle.load(ckpt_file, map_location=self.device)
            ...
            if self.args.ckpt is not None:
                ...
                ckpt_file = self.args.ckpt
                ckpt = paddle.load(ckpt_file, map_location=self.device)["model"]
